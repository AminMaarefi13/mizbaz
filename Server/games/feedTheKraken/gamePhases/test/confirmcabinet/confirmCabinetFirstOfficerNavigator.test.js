...
test("If both first officer and navigator are selected, phase should be cabinet_confirmed", async () => {
  ...
  await confirmCabinet(
    ...
    io,
    {},
    { emergency: false, firstOfficerId: "2", navigatorId: "3" }
  );
...
// Emergency mode test
test("If both first officer and navigator are selected and emergency is true, phase should be emergency_cabinet_confirmed", async () => {
  ...
  await confirmCabinet(
    ...
    io,
    {},
    { emergency: true, firstOfficerId: "2", navigatorId: "3" }
  );
