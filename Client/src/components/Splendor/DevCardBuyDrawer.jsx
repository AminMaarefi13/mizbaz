...
const COLORS = ["white", "blue", "red", "green", "black", "yellow"];
      ...
      >
        ...
        {devCard.color !== "unknown" && (
          <HoldToConfirmButton
            ...
            disabled={hasEnoughChips ? false : !canBuyWithYellow || confirmed}
          />
        )}
        {/* دکمه رزرو */}
        {!reserved && (
          <HoldToConfirmButton
            ...
            label={"رزرو کارت"}
            disabled={confirmed || player.reservedCards.length >= 3}
          />
        )}
      </div>
      <style>{`
